...
import { idlFactory } from './bear-claim-canister.did.js';
export { idlFactory } from './bear-claim-canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BEAR_CLAIM_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./bear-claim-canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the bear-claim-canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./bear-claim-canister.did.js")._SERVICE>}
 */
export const bear_claim_canister = createActor(canisterId);
